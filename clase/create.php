<?php include("../template/barra_navegacion.php"); ?>
   ...
   <h4 class="text-secondory">Registro de clase</h4>
    ...
    include "../controllers/clase/registro_clase.php";
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="numero" name="numero"  maxlength="2" required disabled oninput="checknumero()">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="nombre" name="nombre" maxlength="30" required disabled oninput="checknombre()">
